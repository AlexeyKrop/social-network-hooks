          ...
          <ul className={s.button__group}>
            <li className={s.photo__btn}>
              <button>
                ...
                <span className={s.text}>Photo</span>
              </button>
            </li>
            <li className={s.video__btn}>
              <button type="submit">
                <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20"
                     fill="#FF3E3E">
                  <path
                ...
                <span className={s.text}>Video</span>
              </button>
            </li>
            <li className={s.document__btn}>
              <button>
                <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20"
                     fill="#d8e1f0">
                  <path
                ...
                <span className={s.text}>Document</span>
              </button>
            </li>
            <li className={s.post__btn}>
              <button>Post</button>
            </li>
          </ul>
        </form>
